        ...
        {viewMode === 'landing' ? (
                ...
                <div className="bg-white/80 border border-slate-200/60 rounded-xl p-3.5 flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-[9px] text-slate-400">Pension & Aid</span>
                              ...
                              {/* ==================== HOW TO REGISTER + AFTER REGISTRATION (3-COLUMN LAYOUT) ==================== */}
          <div className="w-full bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-3xl p-6 md:p-8 shadow-sm">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-black text-lg md:text-xl text-slate-800 uppercase tracking-tight">Paano Mag-rehistro? / How to Register?</h2>
                <p className="text-[10px] text-slate-400 font-medium">Sundin ang mga hakbang sa ibaba • Follow the steps below</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] text-slate-600 leading-relaxed">
                  Puntahan ang inyong Barangay Hall o OSCA Office. Ang LGU Encoder ang magpa-fill up sa inyo:
                </p>

                <div className="space-y-2">
                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">1</div>
                      <span className="text-[10px] font-bold text-slate-700">Lokasyon at Address</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">Region, Province, City/Town, Barangay, at address ng tirahan.</p>
                  </div>

                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">2</div>
                      <span className="text-[10px] font-bold text-slate-700">Disaster Risk Info</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">Kung nasa risk area (baha, landslide) at severity level.</p>
                  </div>

                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">3</div>
                      <span className="text-[10px] font-bold text-slate-700">Personal na Impormasyon</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">Pangalan, contact, birthdate, sex, civil status, blood type, religion, education.</p>
                  </div>

                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">4</div>
                      <span className="text-[10px] font-bold text-slate-700">IDs, Trabaho, at Status</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">GSIS, SSS, TIN, PhilHealth, employment, classification, pension, emergency contact.</p>
                  </div>

                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">5</div>
                      <span className="text-[10px] font-bold text-slate-700">Address Pin sa Mapa</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">I-pinpoint sa mapa ang lokasyon ng inyong bahay.</p>
                  </div>

                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">6</div>
                      <span className="text-[10px] font-bold text-slate-700">Biometric na Litrato</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">Portrait photo para sa OSCA ID at facial recognition.</p>
                  </div>

                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">7</div>
                      <span className="text-[10px] font-bold text-slate-700">Digital na Pirma</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">Pipirmahan sa digital signature pad.</p>
                  </div>

                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center text-[9px] font-bold shrink-0">8</div>
                      <span className="text-[10px] font-bold text-slate-700">Fingerprint Scan</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">Scan ng fingerprint gamit ang biometric device.</p>
                  </div>
                  ...
                  <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-2.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-slate-700">Repaso at I-submit</span>
                    </div>
                    <p className="text-[9px] text-slate-500 pl-7 mt-0.5">I-review lahat, tapos i-submit para sa OSCA approval.</p>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-2.5 flex items-start gap-2">
                  ...
                  <p className="text-[9px] text-amber-700"><strong>Paalala:</strong> Ang rehistrasyon ay LIBRE. Huwag magbigay ng pera.</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-[10px] text-slate-600 leading-relaxed">
                  Visit your Barangay Hall or OSCA Office. An LGU Encoder will assist you:
                </p>

                <div className="space-y-2">
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 1 — Location & Address</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Region, Province, City/Town, Barangay, and complete home address.</p>
                  </div>
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 2 — Disaster Risk Info</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Whether you live in a disaster-prone area and severity level.</p>
                  </div>
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 3 — Personal Details</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Full name, mobile, birthdate, sex, civil status, blood type, religion, education.</p>
                  </div>
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 4 — IDs, Employment & Status</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Gov't ID numbers, employment, classification, pension, emergency contact.</p>
                  </div>
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 5 — Address Map Pin</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Pinpoint your home location on the map for geotagging.</p>
                  </div>
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 6 — Biometric Photo</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Portrait photo for OSCA ID and facial recognition.</p>
                  </div>
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 7 — Digital Signature</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Sign on the digital signature pad as proof of registration.</p>
                  </div>
                  <div className="bg-blue-50/50 border border-blue-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-blue-700">Step 8 — Fingerprint Scan</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Fingerprint scanned via biometric device for secure ID.</p>
                  </div>
                  <div className="bg-emerald-50/50 border border-emerald-100/60 rounded-xl p-2.5">
                    <span className="text-[10px] font-bold text-emerald-700">Step 9 — Review & Submit</span>
                    <p className="text-[9px] text-slate-500 mt-0.5">Review for accuracy, then submit. You'll get an SMS once approved.</p>
                  </div>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-2.5 flex items-start gap-2">
                  <AlertTriangle size={12} className="text-amber-600 shrink-0 mt-0.5" />
                  <p className="text-[9px] text-amber-700"><strong>Reminder:</strong> Registration is FREE. Do not give money to anyone.</p>
                </div>
              </div>

              {/* ===== COLUMN 3: PAGKATAPOS NG REGISTRATION ===== */}
              <div className="space-y-4">
                <div className="inline-flex items-center gap-1.5 bg-indigo-50 border border-indigo-100 px-3 py-1 rounded-full">
                  <span className="text-[9px] font-extrabold text-indigo-700 uppercase tracking-widest font-mono">✨ PAGKATAPOS NG REGISTRATION</span>
                </div>

                <p className="text-[10px] text-slate-600 leading-relaxed">
                  Pagkatapos i-submit, ito ang mga susunod:
                </p>

                {/* Approval */}
                <div className="bg-teal-50 border border-teal-100 rounded-xl p-3 space-y-1.5">
                  <div className="flex items-center gap-2">
                    <CheckCircle size={13} className="text-teal-600 shrink-0" />
                    <span className="text-[10px] font-bold text-teal-800">Approval & OSCA ID</span>
                  </div>
                  <p className="text-[9px] text-slate-500 pl-5">Ire-review ng MSWDO Officer. Pag-approved, may SMS at Digital OSCA ID kayo.</p>
                  <p className="text-[9px] text-blue-500 pl-5 italic">Once approved, you'll receive SMS + your Digital OSCA ID Card.</p>
                </div>
                ...
                <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-3 space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-indigo-800">NCSC Data Form Interview</span>
                  </div>
                  <p className="text-[9px] text-slate-500 pl-5">Follow-up interview para sa national database ng NCSC:</p>
                  <ul className="text-[9px] text-slate-500 pl-5 list-disc list-inside space-y-0.5">
                    <li>Economic Profile (kita, pension, ari-arian)</li>
                    <li>Health Profile (kalusugan, sakit, gamot)</li>
                    <li>Household Profile (bahay, caregiver)</li>
                    <li>Participation & Needs</li>
                  </ul>
                  <p className="text-[9px] text-blue-500 pl-5 italic">Post-approval interview for the NCSC national senior citizen database.</p>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-3 space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-amber-800">Centenarian Honoring (RA 11982)</span>
                  </div>
                  <p className="text-[9px] text-slate-500 pl-5">Cash gift kung umabot sa milestone age:</p>
                  <div className="pl-5 space-y-1 mt-1">
                    <div className="flex justify-between text-[9px] bg-white/80 px-2 py-1 rounded-lg border border-amber-100">
                      <span className="text-amber-700 font-bold">80 & 85 y/o</span>
                      <span className="font-black text-amber-800">₱10,000</span>
                    </div>
                    <div className="flex justify-between text-[9px] bg-white/80 px-2 py-1 rounded-lg border border-amber-100">
                      <span className="text-amber-700 font-bold">90 & 95 y/o</span>
                      <span className="font-black text-amber-800">₱10,000</span>
                    </div>
                    <div className="flex justify-between text-[9px] bg-white/80 px-2 py-1 rounded-lg border border-red-100">
                      <span className="text-red-600 font-bold">100+ y/o</span>
                      <span className="font-black text-red-700">₱100,000</span>
                    </div>
                  </div>
                  <p className="text-[9px] text-amber-600 pl-5 italic mt-1">I-claim sa loob ng 1 taon. Kailangan ng LCE endorsement.</p>
                </div>

                {/* Deceased Reporting */}
                <div className="bg-slate-100 border border-slate-200 rounded-xl p-3 space-y-1.5">
                  <div className="flex items-center gap-2">
                    <span className="w-5 h-5 rounded-full bg-slate-500 text-white flex items-center justify-center text-[9px] font-bold shrink-0">†</span>
                    <span className="text-[10px] font-bold text-slate-700">Deceased / Pagpanaw</span>
                  </div>
                  <p className="text-[9px] text-slate-500 pl-7">Kung pumanaw na ang senior, i-report sa OSCA para ma-update ang record. Kailangan ang Date of Death at Cause of Death.</p>
                  <p className="text-[9px] text-blue-500 pl-7 italic">Report to OSCA for record update. Required for Posthumous Plaque of Recognition.</p>
                </div>
              </div>
