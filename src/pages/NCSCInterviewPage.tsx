...
export default function NCSCInterviewPage() {
  ...
  const handleSubmit = () => {
    ...
    showToast(`NCSC Data Form of ${senior?.firstName} ${senior?.lastName} has been successfully saved!`, 'success');
      ...
      <div className="space-y-6 animate-fadeIn">
        ...
        <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-indigo-800">What is the NCSC Data Form?</p>

            <p className="text-[10px] text-indigo-600 mt-1 leading-relaxed">

              The National Commission of Senior Citizens (NCSC) launched an online registration to build a reliable database of all Filipino Senior Citizens. 

              This is a data build-up campaign for NCSC's plans, programs, and services. After the OSCA ID is approved, a follow-up interview is needed for the senior's Economic, Health, and Household Profile.
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              placeholder="Search for approved senior (name or OSCA number)..."
          ...
          <div className="space-y-2 max-h-96 overflow-y-auto">
            ...
            {filteredSeniors.length === 0 ? (
              ...
              <div className="text-center py-8 text-slate-400">
                ...
                <p className="text-xs font-medium">No approved senior citizens found.</p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Income Source</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Estimated Monthly Income</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-xs text-slate-700">Receiving Pension?</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-xs text-slate-700">Receiving DSWD Social Pension?</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-xs text-slate-700">Indigent / Insufficient Income?</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-xs text-slate-700">Owns Property?</label>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">General Health Condition</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Mobility</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Last Check-up</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Preferred Hospital / Clinic</label>
            ...
            <div>
              ...
              <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 block">Illnesses — Select all that apply:</label>
            ...
            <div className="flex items-center gap-3">
              ...
              <label className="text-xs text-slate-700">Has PhilHealth Coverage?</label>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Living Arrangement</label>
                ...
                >
                  ...
                  <option value="Institution">Institution / Home for the Aged</option>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Household Size</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Housing Type</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Caregiver Name (if any)</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Caregiver Relationship</label>
              ...
              <div>
                ...
                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Caregiver Contact</label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-xs text-slate-700">Has Water</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-xs text-slate-700">Has Electricity</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label className="text-xs text-slate-700">Has Sanitation</label>
        ...
        {currentSection === 3 && (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <label className="text-xs text-slate-700 font-medium">Member of Senior Citizens Organization?</label>
            ...
            <div>
              ...
              <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 block">Activities Joined:</label>
            ...
            <div>
              ...
              <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 block">Primary Needs:</label>
        ...
        {currentSection === 4 && (
          ...
          <div className="space-y-4">
            ...
            <h3 className="font-bold text-sm text-slate-700 flex items-center gap-2">
              ...
              <CheckCircle size={14} className="text-emerald-500" /> Review & Submit
